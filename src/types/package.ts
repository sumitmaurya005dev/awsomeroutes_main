...
export type PackageDayActivity = {
  ...
  notes: string | null;
  display_order: number;
  offering?: PackageActivityOffering | null;
...
export type PackageItineraryDay = {
  ...
  notes: string | null;
  start_location?: PackageLocation | null;
  end_location?: PackageLocation | null;
  overnight_location?: PackageLocation | null;
  activities: PackageDayActivity[];
  hotels: PackageDayHotel[];
};
export type PackageVehicleOption = {
  ...
  notes: string | null;
  display_order: number;
  base_location?: PackageLocation | null;
  category?: { id: string; name: string } | null;
...
export type PackageContentTemplateItem = {
  id: string;
  section_id: string;
  content: string;
  display_order: number;
...
export type PackageContentTemplateSection = {
  id: string;
  template_id: string;
  section_type: PackageContentType;
  title: string;
  display_order: number;
  created_at: string;
  updated_at: string;
  items: PackageContentTemplateItem[];
};
export type PackageContentTemplate = {
  id: string;
  name: string;
  slug: string;
  version: number;
  ...
  created_at: string;
  updated_at: string;
  sections: PackageContentTemplateSection[];
};
...
export type PackagePriceAdjustment = {
  id: string;
  package_id: string;
  hotel_category_id: string;
  markup_bps: number;
...
export type PackageDetail = {
  ...
  created_at: string;
  updated_at: string;
  primary_destination: PackageDestination | null;
  start_location: PackageLocation | null;
  end_location: PackageLocation | null;
  featured_image: PackageAsset | null;
...
export type PackageActivityOffering = {
  ...
  tax_rate_bps: number;
  status: string;
  activity: { id: string; name: string; status: string } | null;
...
export type PackageReferenceData = {
  ...
  hotel_categories: Array<{ id: string; name: string; slug: string }>;
  hotels: PackageHotelOption[];
  hotel_rates: HotelRateCard[];
  activity_offerings: PackageActivityOffering[];
  vehicle_categories: Array<{ id: string; name: string }>;
  vehicle_models: Array<{ id: string; name: string; category_id: string }>;
  vehicle_vendors: Array<{
    id: string;
    name: string;
    base_location_id: string;
  }>;
  vehicle_rates: VehicleRateCard[];
};
