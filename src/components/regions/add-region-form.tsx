  ...
  return (
    <>
        ...
        <div className="grid gap-5 sm:grid-cols-2">
          <label className="space-y-2 text-sm font-medium">
            ...
            <select
              ...
              onChange={(event) => update("country_id", event.target.value)}
              required
              disabled={saving}
          ...
          <div className="space-y-2 sm:col-span-2">
            <p className="text-sm font-medium">Region image</p>
            {form.image_url && (
              <div className="relative overflow-hidden rounded-xl border border-border">
                <Image
                  src={form.image_url}
                  alt={form.name || "Region image"}
                  width={800}
                  height={360}
                  unoptimized
      ...
      <MediaPickerDialog
        ...
        fileNamePrefix={form.slug || "region"}
        altText={form.name || "Region image"}
        onSelect={(asset) =>
          setForm((current) => ({
            ...current,
