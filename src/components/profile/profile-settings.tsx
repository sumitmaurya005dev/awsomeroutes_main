...
type ProfileSettingsProps = {
  profile: { firstName: string | null; lastName: string | null; phone: string | null; email?: string; avatar: string | null; role: { name: string } };
};
