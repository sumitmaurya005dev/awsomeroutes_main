...
import { changeOwnPassword, deleteOwnAccount, updateOwnProfile } from "@/lib/profile/actions";
  ...
  const removeAccount = async (event: React.FormEvent) => {
    ...
    try {
      const result = await deleteOwnAccount({
        ...
        confirmation: deletionConfirmation as "DELETE MY ACCOUNT",
      });
      if (!result.success) {
        setError(result.error);
        return;
